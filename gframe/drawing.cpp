...
void Game::DrawMisc() {
	...
	if(!dInfo.isReplay && dInfo.player_type < 7 && dInfo.time_limit) {
		numFont->draw(L"/", Resize(455, 31, 525, 50), 0xffffffff, true, false, 0);
		numFont->draw(L"/", Resize(795, 31, 865, 50), 0xffffffff, true, false, 0);
		numFont->draw(dInfo.str_time_left[0], Resize(455, 31, 490, 50), 0xffffffff, true, false, 0);
		numFont->draw(dInfo.str_time_limit, Resize(490, 31, 525, 50), 0xffffffff, true, false, 0);
		numFont->draw(dInfo.str_time_left[1], Resize(795, 31, 830, 50), 0xffffffff, true, false, 0);
		numFont->draw(dInfo.str_time_limit, Resize(830, 31, 865, 50), 0xffffffff, true, false, 0);
