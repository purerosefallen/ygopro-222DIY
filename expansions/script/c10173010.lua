...
function c10173010.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		e:SetLabel(0)
		return e:GetHandler():IsAbleToRemoveAsCost() and Duel.IsExistingMatchingCard(c10173010.rfilter2,tp,LOCATION_GRAVE,0,1,nil,e,tp) and Duel.GetMZoneCount(tp)>0 
	end
	e:SetLabel(0)
