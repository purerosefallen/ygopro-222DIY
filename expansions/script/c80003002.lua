...
function c80003002.initial_effect(c)
	...
	e1:SetCountLimit(1,80003002)
	e1:SetTarget(c80003002.thtg)
	e1:SetOperation(c80003002.thop)
	c:RegisterEffect(e1)
	--spsummon
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringid(80003002,1))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON+CATEGORY_FUSION_SUMMON)
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_GRAVE)
	e2:SetCountLimit(1,80003003)
	e2:SetTarget(c80003002.sptg)
	e2:SetOperation(c80003002.spop)
	c:RegisterEffect(e2)
	--cannot be material
...
function c80003002.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(c80003002.filter),tp,LOCATION_DECK,0,1,1,nil)
...
function c80003002.spop(e,tp,eg,ep,ev,re,r,rp)
	local chkf=tp
	local mg1=Duel.GetFusionMaterial(tp):Filter(c80003002.mfilter1,nil,e)
