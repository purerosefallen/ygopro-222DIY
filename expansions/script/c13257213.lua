...
function c13257213.initial_effect(c)
	...
	e1:SetOperation(c13257213.activate)
	c:RegisterEffect(e1)
	--Activate
	...
	e2:SetCost(c13257213.cost)
	e2:SetTarget(c13257213.target2)
	e2:SetOperation(c13257213.activate2)
	c:RegisterEffect(e2)
...
function c13257213.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsAbleToRemoveAsCost() end
	Duel.Remove(e:GetHandler(),POS_FACEUP,REASON_COST)
end
function c13257213.target2(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsControler(1-tp) and chkc:IsLocation(LOCATION_MZONE) end
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and Duel.IsExistingTarget(aux.TRUE,tp,0,LOCATION_MZONE,1,nil) and Duel.IsExistingMatchingCard(c13257213.filter,tp,LOCATION_HAND,0,1,nil,e,tp) end
