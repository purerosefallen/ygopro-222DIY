...
function c22240001.hspcon(e,c)
	...
	return Duel.IsExistingMatchingCard(c22240001.spfilter,c:GetControler(),LOCATION_MZONE,0,1,nil) or (Duel.GetMZoneCount(c:GetControler())>0 and Duel.IsExistingMatchingCard(c22240001.spfilter,c:GetControler(),LOCATION_ONFIELD,0,1,nil))
end
